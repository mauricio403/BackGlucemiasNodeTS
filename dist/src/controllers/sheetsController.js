...
const test = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // console.log(doc.tit|le);
    // await doc.updateProperties({ title: 'testDeGlicemia3' });
    // console.log(doc.titl|e);
    const sheet = doc.sheetsByIndex[0]; // or use doc.sheetsById[id] or doc.sheetsByTitle[title]
    // console.log(sheet.tit|le);
    // console.log(sheet.row|Count);
    // adding / removing sheets
    // const newSheet = await doc.addSheet({ title: 'niñoTest3' });
